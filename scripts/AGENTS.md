...
| `verify-windows-toolchain.ps1` | Waits for exact published manifest, installs five tools in fresh temp root, runs native aria2 RPC lifecycle; See change: owned-toolchain. |
