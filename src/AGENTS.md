...
| `main.ts` | Points app updates to damageboy/yt-dlp-tauri; See change: fork-release-builds. Consolidates aria2c Toolchain controls; refreshes readiness after Save; sends selected output_format; locks download selectors while busy; See change: aria2c-external-downloader. See change: aria2c-required-tool. See change: download-format-selector. English/Chinese help describes shared native fragment and aria2c parallelism; See change: native-fragment-parallelism. |
