...
| `lib.rs` | Requires aria2c for readiness and runtime preflight; uses managed Homebrew aria2c independently of custom overrides; See change: aria2c-external-downloader. See change: aria2c-required-tool. |
