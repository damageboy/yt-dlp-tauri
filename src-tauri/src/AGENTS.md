...
| `aria2c_rpc_tests.rs` | Tolerates client timeout disconnects and Windows connection-refusal timing; See change: fork-release-builds. Verifies RPC progress, queue shutdown, transport and session lifecycle; See change: aria2c-rpc-progress. |
